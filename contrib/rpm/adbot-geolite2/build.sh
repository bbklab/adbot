...
spec="${base}/adbot-geolite2-rhel7.spec"
...
prepare() {
	test -e share/geo/GeoLite2-ASN.mmdb -a -r  share/geo/GeoLite2-ASN.mmdb
	test -e share/geo/GeoLite2-City.mmdb -a -r share/geo/GeoLite2-City.mmdb
	mkdir -p $product
}
