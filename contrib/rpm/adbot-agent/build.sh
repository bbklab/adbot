...
spec="${base}/adbot-agent-rhel7.spec"
...
prepare() {
	...
	test -e systemd/adbot-agent.service  -a -r systemd/adbot-agent.service
	test -e etc/agent.env.example -a -r etc/agent.env.example
